...
extension Tasks {
    ...
    static var previewData: [Tasks] = [
        ...
        Tasks(title: "Task2", detail: "", addedDate: Date().addingTimeInterval(-60*60*24*30), spanType: .everyDay, spanDate: [], doneDate: [], notification: false, notificationHour: 0, notificationMin: 0, accentColor: "Red"),
        Tasks(title: "Task3", detail: "", addedDate: Date().addingTimeInterval(-60*60*24*30), spanType: .everyDay, spanDate: [], doneDate: [], notification: false, notificationHour: 0, notificationMin: 0, accentColor: "Green"),
