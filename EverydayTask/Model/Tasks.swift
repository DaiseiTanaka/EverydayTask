...
struct Tasks: Codable, Identifiable, Equatable, Hashable {
    ...
    init(title: String, detail: String, addedDate: Date, spanType: TaskSpanType, spanDate: [Int], doneDate: [Date], notification: Bool, notificationHour: Int, notificationMin: Int, accentColor: String, able: Bool) {
        self.title = title
        self.detail = detail
...
//        Tasks(title: "Task5", detail: "Once a month", addedDate: Date().addingTimeInterval(-60*60*24*200), spanType: .everyMonth, spanDate: [], doneDate: [Date().addingTimeInterval(-60*60*24*150), Date().addingTimeInterval(-60*60*24*90),Date().addingTimeInterval(-60*60*24*60), Date().addingTimeInterval(-60*60*24*30), Date()], notification: false, notificationHour: 0, notificationMin: 0, accentColor: "Black")
    ...
    Tasks(title: "", detail: "", addedDate: Date(), spanType: .everyDay, spanDate: [], doneDate: [], notification: false, notificationHour: 0, notificationMin: 0, accentColor: "Blue", able: true)
    
    static var defaulData: [Tasks] = [
        Tasks(title: "Task1", detail: "Every day", addedDate: Date(), spanType: .everyDay, spanDate: [], doneDate: [], notification: false, notificationHour: 0, notificationMin: 0, accentColor: "Blue", able: true),
        Tasks(title: "Task2", detail: "Every day", addedDate: Date(), spanType: .everyDay, spanDate: [], doneDate: [], notification: false, notificationHour: 0, notificationMin: 0, accentColor: "Green", able: true)
    ]
}
